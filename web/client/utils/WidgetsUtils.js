...
export const FILTER_PROPS = ["selectedFilterId", "id", "mapSync", "widgetType", "filters", "selections", "dependenciesMap", "dataGrid", "title", "description"];
...
const filterWidgetOperation = ({ editorData, key, value }) => {
    ...
    if (key === 'filter-add') {
        ...
        // createNewFilter signature: (filtersCount = 0) => { id, variant, label, name, icon, selectionMode, layout, items, data }
