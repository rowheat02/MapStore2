...
describe('InteractionUtils', () => {
    ...
    describe('generateChartWidgetTreeNode', () => {
        ...
        it('adds apply dimension targets for trace date axes with current time availability metadata', () => {
            ...
            const trace = tree.children[0].children[0].children[0].children[0].children[2];
        ...
        it('builds apply dimension target paths for missing default axis options', () => {
            const tree = generateRootTree([{
                id: 'chart-widget-missing-axis-options',
                widgetType: 'chart',
                charts: [{
                    chartId: 'chart-1',
                    traces: [{ id: 'trace-1', type: 'bar' }]
            ...
            const traceCollection = tree.children[0]
                .children[0]
                .children[0]
                .children[0]
                .children[1];
