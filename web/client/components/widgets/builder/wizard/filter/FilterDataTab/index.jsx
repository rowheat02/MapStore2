...
const FilterDataTab = ({
    ...
    const filterDataState = useFilterData(data, layerSources);
...
const layerSourcesSelector = createSelector(
...
export default connect(
    (state) => layerSourcesSelector(state)
)(FilterDataTab);
