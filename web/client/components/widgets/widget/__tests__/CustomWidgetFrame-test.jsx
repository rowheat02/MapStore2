...
describe.only('CustomWidgetFrame component', () => {
    beforeEach((done) => {
    ...
    it('renders header icons including expand (maximize) when showMaximize is enabled', () => {
        ReactDOM.render(
            <CustomWidgetFrame
                {...base}
        ...
        const icons = root.querySelector('.widget-icons');
        expect(icons).toExist();
        expect(icons.querySelector('.glyphicon-resize-full')).toExist();
    });
